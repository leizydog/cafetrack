...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $res = register_user($username, $email, $password, 'staff');
    if($res['success']){
...
<title>CafeKantina - Register</title>
<style>
...
<div class="auth-container">
  ...
  <?php if($message): ?>
    <p id="register-message" class="error"><?php echo htmlspecialchars($message); ?></p>
  <?php endif; ?>
  <form method="POST" action="register.php">
    ...
    <div class="form-group">
      ...
      <input type="email" id="reg-email" name="reg-email" placeholder="Enter your email address" required>
    </div>
    <div class="form-group">
