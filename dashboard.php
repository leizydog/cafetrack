...
<div class="navbar">
  <div class="brand" onclick="location.href='dashboard.php'">
    ...
    <div>
      <h1>CafeKantina</h1>
      <div style="font-size:12px;color:rgba(255,255,255,0.9);margin-top:2px">Premium Coffee Management</div>
    </div>
  </div>
    ...
    <div class="profile" id="profileRoot">
      <div class="profile-btn" onclick="toggleProfile()">
        <div style="text-align:left">
          ...
          <div style="font-size:12px;color:rgba(255,255,255,0.85)">Barista</div>
        </div>
...
<div class="header" role="banner">
  <div>
    <div class="greeting" id="greeting">Good day, <?php echo htmlspecialchars($username); ?> — ready to serve?</div>
...
<div class="main">
  <div class="left">
    <div class="cards" aria-live="polite">
      <div class="card" onclick="location.href='order.php'">
        <div class="icon"><i class="fas fa-mug-hot"></i></div>
        <div class="meta"><div class="title">Order</div><div class="sub">Create new orders</div></div>
      </div>
      ...
      <div class="card" onclick="location.href='cash_drawer.php'">
        <div class="icon"><i class="fas fa-cash-register"></i></div>
        <div class="meta"><div class="title">Cash Drawer</div><div class="sub">Open/Close cash drawer</div></div>
      </div>
    </div>
  ...
  <aside class="right">
    ...
    <div class="panel">
      <div style="display:flex;justify-content:space-between;align-items:center">
        ...
        <small class="small">Tap to open</small>
      </div>
      <div style="display:flex;flex-direction:column;gap:12px;margin-top:12px">
        <button class="btn" onclick="location.href='order.php'"><i class="fas fa-mug-hot" style="margin-right:8px"></i> New Order</button>
        <button class="btn secondary" onclick="location.href='inventory.php'"><i class="fas fa-boxes" style="margin-right:8px"></i> Inventory</button>
        <button class="btn secondary" onclick="location.href='report.php'"><i class="fas fa-file-alt" style="margin-right:8px"></i> Reports</button>
      </div>
    </div>
